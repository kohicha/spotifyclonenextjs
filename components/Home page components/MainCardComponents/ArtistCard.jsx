...
export default function ArtistCard() {
  return (
    <Link shallow={true} href={"/artist"} className="aspect-[5/7] min-w-[150px] w-48 p-4 flex flex-col gap-4 rounded-md
    ...
    ">
      ...
      <p className="text-base font-normal flex flex-col gap-2">
        <span className="font-semibold">Keru6k</span>
        <span className="text-sm text-fontGray ">Artist</span>
      </p>
    </Link>
  )
}
